...
module.exports = class Table {
  ...
  insert(data, cb) {
    /* FIX  with upsert
    collection: 'tags_users__users_tags',
    criteria: { tags_users: '1', users_tags: '1' },
    values: { tags_users: '1', users_tags: '1' },
     Error: Trying to '.add()' an instance which already exists!
    */
